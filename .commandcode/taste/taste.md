...
- For the photo-sorter deployment, the server's photos mount path is /srv/mergerfs/pool/pool/photos/Unsorted (container /photos), with Best exported at /srv/mergerfs/pool/pool/photos/Best (not /mnt/nas/pool/photos). Confidence: 0.70
